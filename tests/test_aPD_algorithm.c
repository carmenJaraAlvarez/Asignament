...
void testInitAProblemPD_2(PAproblemPD papd, Aproblem a){
	printf("\n*** testInitAProblemPD ***\n");
	int res=-1;
...
void testInit9(){
	...
	Cadena url="/home/practica/eclipse-workspace/c/files/data11.txt";
	...
	//exec_algorithm(&alg);//TODO change post gui
	printf("\nAfter exec algoritm\n");
	Solution sol;
